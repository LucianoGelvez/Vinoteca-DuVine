...
const estadoErroresOK = {
    ...
    estadoErroresOK.repetirContrasenia = validarRepetirContrasenia( estadoUsuario.contrasenia, estadoUsuario.repetirContrasenia);
    


    function mostrarErrores() {
            // por cada small mostramos u ocultamos el error
            estadoErroresOK.nombre ? null: nombreError.textContent="Debe ser un Nombre válido";
            estadoErroresOK.apellido ? null: apellidoError.textContent="Debe ser un Apellido válido";
            estadoErroresOK.email ? null : emailError.textContent="Debe ser un Email válido";
            estadoErroresOK.contrasenia ? null : contraseniaError.textContent="Deben ser al menos 6 caracteres sin espacios e incluir un número y un caracter especial";
            estadoErroresOK.repetirContrasenia ? null: repetirContraseniaError.textContent="Las contraseñas no coinciden";
        }
...
function validarApellido(apellido){
    let resultado = false;
    if (typeof apellido === "string" && apellido.length > 3 && !apellido.includes(' ')) {
        resultado = true;
        console.log(resultado);
    }
    return resultado;
...
if (estadoErroresOK.nombre && estadoErroresOK.apellido && estadoErroresOK.email && estadoErroresOK.contrasenia && estadoErroresOK.repetirContrasenia){
